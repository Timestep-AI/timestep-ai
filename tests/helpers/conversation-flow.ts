...
export interface ConversationStep {
  user: string;
  expectAssistant?: string | RegExp;
  approvals?: string[];
  switchAgentTo?: string; // optional — supports agent switching mid-test
}

export async function runConversationFlow(page: Page, steps: ConversationStep[]) {
...
async function waitForNextAssistantTurn(assistantTurns: Locator, prevCount: number) {
  await expect
