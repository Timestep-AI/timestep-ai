...
import { z } from 'zod';
import { HEADERS } from './defaults.ts';
import {
...
import { camelOrSnakeToSnakeCase } from './utils/providerData.ts';
import { ProviderData } from '@openai/agents-core/types';

// encodeUint8ArrayToBase64 is not exported from npm package, so we implement it here
// Matches implementation from @openai/agents-core/src/utils/base64.ts
