-- Fix the conversations table schema to match the new format
-- First, drop the old conversations table if it exists
DROP TABLE IF EXISTS conversations CASCADE;

-- Create the new conversations table with proper schema
